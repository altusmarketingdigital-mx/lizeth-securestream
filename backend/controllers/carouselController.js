...
exports.getImages = async (req, res) => {
    try {
        const result = await db.query('SELECT id, image_data FROM carousel_images ORDER BY created_at ASC');
...
exports.addImage = async (req, res) => {
    ...
    try {
        const id = uuidv4();
        await db.query('INSERT INTO carousel_images (id, image_data) VALUES ($1, $2)', [id, image_data]);
