...
exports.sendNewPassword = async (email, name, newPassword) => {
    const html = getBaseTemplate(` 
        ...
        <p>Hola ,</p>
        <p>El administrador de Lizeth The Barberette ha generado una nueva contrase�a temporal para tu cuenta.</p>
        ...
        <p>Por favor, inicia sesi�n con esta contrase�a. Te recomendamos cambiarla por una de tu preferencia desde la secci�n <strong>Seguridad</strong> en tu panel.</p>
        <div style="text-align: center; margin-top: 30px;">
            <a href="/login.html" class="btn">Iniciar Sesi�n Ahora</a>
        </div>
    `);
    return sendEmail({ to: email, subject: 'Tu nueva contrase�a de acceso', html });
};
